        ...
        <div class="block text-center">
          ...
          <h1 class="text-capitalize mb-5 text-lg">Care Department</h1>
           ...
           <li class="list-inline-item"><a href="index" class="     text-white">Home</a></li>
            ...
            <li class="list-inline-item"><a href="department" class="text-white-50">Department</a></li>
          </ul>
        </div>
      </div>
    </div>
		...
		<div class="row">
			<div class="col-lg-4 col-md-6 ">
				<div class="department-block mb-5">
					<img src="user/images/service/service-1.jpg" alt="" class="img-fluid w-100">
					<div class="content">
						<h4 class="mt-4 mb-2 title-color">Opthomology</h4>
						<p class="mb-4">Saepe nulla praesentium eaque omnis perferendis a doloremque.</p>
						<a href="department-single" class="read-more">Learn More  <i class="icofont-simple-right ml-2"></i></a>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6">
				<div class="department-block mb-5">
					<img src="user/images/service/service-2.jpg" alt="" class="img-fluid w-100">
					<div class="content">
			...
			<div class="col-lg-4 col-md-6">
				<div class="department-block mb-5">
					<img src="user/images/service/service-3.jpg" alt="" class="img-fluid w-100">
					<div class="content">
			...
			<div class="col-lg-4 col-md-6 ">
				<div class="department-block  mb-5 mb-lg-0">
					<img src="user/images/service/service-4.jpg" alt="" class="img-fluid w-100">
					<div class="content">
			...
			<div class="col-lg-4 col-md-6">
				<div class="department-block mb-5 mb-lg-0">
					<img src="user/images/service/service-6.jpg" alt="" class="img-fluid w-100">
					<div class="content">
			...
			<div class="col-lg-4 col-md-6">
				<div class="department-block mb-5 mb-lg-0">
					<img src="user/images/service/service-8.jpg" alt="" class="img-fluid w-100">
					<div class="content">
