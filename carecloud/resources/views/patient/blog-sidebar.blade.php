      ...
      <div class="col-md-12">
        ...
        <ul class="list-inline breadcumb-nav">
           <li class="list-inline-item"><a href="index" class="text-white">Home</a></li>
            ...
            <li class="list-inline-item"><a href="blog-sidebar" class="text-white-50">Blog</a></li>
          </ul>
        </div>
      </div>
    </div>
...
<section class="section blog-wrap">
	...
	<div class="col-lg-12 col-md-12 mb-5">
		<div class="blog-item">
			<div class="blog-thumb">
				<img src="user/images/blog/blog-1.jpg" alt="" class="img-fluid ">
			</div>
			...
			<div class="blog-item-content">
				...
				<h2 class="mt-3 mb-3"><a href="blog-single">Choose quality service over cheap service  all type of things</a></h2>
				...
				<a href="blog-single" target="_blank" class="btn btn-main btn-icon btn-round-full">Read More <i class="icofont-simple-right ml-2  "></i></a>
			</div>
		</div>
	</div>
	...
	<div class="col-lg-12 col-md-12 mb-5">
		<div class="blog-item">
			<div class="blog-thumb">
				<img src="user/images/blog/blog-2.jpg" alt="" class="img-fluid">
			</div>
			...
			<div class="blog-item-content">
				...
				<h2 class="mt-3 mb-3"><a href="blog-single">All test cost 25% in always in our laboratory</a></h2>
	...
	<div class="col-lg-12 col-md-12 mb-5">
		<div class="blog-item">
			<div class="blog-thumb">
				<img src="user/images/blog/blog-4.jpg" alt="" class="img-fluid">
			</div>
			...
			<div class="blog-item-content">
				...
				<h2 class="mt-3 mb-3"><a href="blog-single">Get Free consulation from our special surgeon and doctors</a></h2>
